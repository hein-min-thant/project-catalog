    ...
    public void sendVerificationCode(String to, String code) {
        ...
        try {
            ...
            String htmlContent = "<html>"
                    ...
                    + "<p style=\"color: #666666;\">Hello,</p>"
                    + "<p style=\"color: #666666;\">You have requested to reset your password. Please use the following code to reset your password:</p>"
                    + "<div style=\"background-color: #dc3545; color: #ffffff; padding: 10px; border-radius: 5px; font-size: 24px; font-weight: bold; margin: 20px auto; display: inline-block;\">"
                    + code
                    + "</div>"
                    + "<p style=\"color: #666666;\">The code is valid for 15 minutes. If you did not request this password reset, please ignore this email.</p>"
                    + "<p style=\"color: #666666;\">For security reasons, please do not share this code with anyone.</p>"
                    + "</div>"
                    + "</body>"
                    + "</html>";
            message.setContent(htmlContent, "text/html");
